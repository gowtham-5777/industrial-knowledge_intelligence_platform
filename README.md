...
|---|---|---|
| **1.1** Project Bootstrap | Monorepo layout, backend/frontend scaffolds, tooling baselines | Planned |
| **1.2** Backend Foundation | FastAPI app, settings, DI, middleware, errors, OpenAPI, health | Planned |
...
**Current engineering focus:** Milestone **1.1 — Project Bootstrap** (next implementation step).
